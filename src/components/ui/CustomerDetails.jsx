...
export default function CustomerDetails({ customerId, onBack }) {
  // Mock data - in a real app, fetch based on customerId
  const customer = {
    name: "Jacob Banda",
    id: "203437192",
    grade: "Reception",
    guardian: "Mr James Banda",
    email: "jamesbanda101@gmail.com",
    phone: "+260712010246",
    enrollmentDate: "28/02/2025",
    openBalance: "ZMW 0",
    dueDate: "ZMW 0",
  };
        ...
        <div className="flex-1 border border-gray-200 rounded-lg p-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-x-12 gap-y-4 text-xs text-gray-500">
                <div>
                  ...
                  <p className="font-semibold text-black">{customer.grade}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-semibold text-black">{customer.id}</p>
                </div>
                <div>
            ...
            <div className="flex flex-col items-end gap-6">
              ...
              <div className="bg-[#E7F9DE] border border-[#003630] rounded-lg p-4 w-60 text-center">
                <div className="mb-2">
                  ...
                  <p className="font-bold text-lg">{customer.openBalance}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500">Due Date</p>
                  <p className="font-bold text-lg">{customer.dueDate}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-[#003630] pt-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-[#003630]">Transaction History</h3>
